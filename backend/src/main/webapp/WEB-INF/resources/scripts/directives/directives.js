...
angular.module('shareTaskApp.directives', []).
	...
	.directive('errorConsole', ['$rootScope', function($rootScope) {
		return {
			restrict: 'E',
			templateUrl: 'resources-'+$rootScope.appVersion+'/views/components/error-console.html',
			link: function(scope, element, attrs) {
	...
	.directive('firstWorkspaceWindow', ['$rootScope', function($rootScope) {
		return {
			restrict: 'E',
			templateUrl: 'resources-'+$rootScope.appVersion+'/views/components/first-workspace-window.html',
			link: function(scope, element, attrs) {
	...
	.directive('help', ['$rootScope', function($rootScope) {
		return {
			restrict: 'E',
			templateUrl: 'resources-'+$rootScope.appVersion+'/views/components/help.html',
			link: function(scope, element, attrs) {
				//Log.debug("scope: %o, element: %o, attrs: %o", scope, element, attrs);
			},
