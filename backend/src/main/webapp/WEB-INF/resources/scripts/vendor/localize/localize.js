        ...
        this.$get = ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
            ...
            var localize = {
                ...
                buildUrl: function() {
                    ...
                    return 'resources-' + $rootScope.appVersion + '/scripts/i18n/resources-locale_' + $rootScope.appLocale.language + '.' + provider.ext;
                },
                ...
                initLocalizedResources:function () {
                    ...
                    $http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function () {
                        ...
                        var url = 'resources-' + $rootScope.appVersion + '/scripts/i18n/resources-locale_default' + '.' + provider.ext;
