...
<html lang="en" data-ng-app="shareTaskApp">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<c:url value="/resources-${applicationVersion}/css/sharetask-app.css" />">
	...
	<body data-ng-cloak>
		...
		<script type="text/javascript" src="<c:url value="/resources-${applicationVersion}/scripts/vendor/angular/i18n/angular-locale_${locale}.js" />"></script>
		<script type="text/javascript" src="<c:url value="/resources-${applicationVersion}/scripts/vendor/angular/angular-google-analytics.js" />"></script>
		<script type="text/javascript" src="<c:url value="/resources-${applicationVersion}/scripts/vendor/localize/localize.js" />"></script>
		<script type="text/javascript" src="<c:url value="/resources-${applicationVersion}/scripts/vendor/md5-min.js" />"></script>
		<script type="text/javascript" src="<c:url value="/resources-${applicationVersion}/scripts/vendor/localize/jquery.ui.datepicker-${language}.js" />"></script>
		...
		<script type="text/javascript">
			...
			angular.module('shareTaskApp', ['ngRoute', 'angular-google-analytics', 'shareTaskApp.filters', 'shareTaskApp.services', 'shareTaskApp.directives', 'shareTaskApp.controllers'])
				.config(['$routeProvider', 'AnalyticsProvider', '$locationProvider', function($routeProvider, AnalyticsProvider, $locationProvider) {
					...
					$routeProvider.when('/workspaces', {templateUrl: '<c:url value="/resources-${applicationVersion}/views/workspaces.html" />'});
					$routeProvider.when('/user', {templateUrl: '<c:url value="/resources-${applicationVersion}/views/user.html" />'});
					$routeProvider.when('/statistics', {templateUrl: '<c:url value="/resources-${applicationVersion}/views/statistics.html" />'});
